...
const TrainingModelSection = (props) => {
    ...
    // Variables used for displaying charts and graphs
    const BOUNDS = 2.0;
        ...
        <div>
            ...
            >
                ...
                <div className={styles.layerCardsContainer}>
                    ...
                    <NeuralNetLayerInput
                        ...
                        layerSize={props.dataset.centroids.length}
            ...
            {Object.keys(trainResult).length !== 0 ? (
                <div>
                    ...
                    <p>
                        Similar to before, the chart below shows the accuracy of
                        the model, i.e., what is the percentage of correctly
                        classified instances across the dataset, where a value
                        of <MathJax inline>{"\\(1\\)"}</MathJax> is the highest.
