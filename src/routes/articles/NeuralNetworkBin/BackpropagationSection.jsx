...
export const BackpropagationSection = () => {
    return (
        <div>
            ...
            <p>
                ...
                <MathJax inline>{"\\(l=L\\)"}</MathJax>, after which gradients
                are propagated backwards. It is necessary to calculate and
                propagate backwards because of the <em>chain rule</em>.{" "}
            </p>

            <p>
                In order to simplify the calculations, subsequent derivations
                calculated the gradient of the <em>loss</em> of any training
                example. As an example, given a particular weight{" "}
    ...
    =\\frac{\\partial L(\\hat{y}^{(i)},y^{(i)})}{\\partial a^{[l]}_k}\\cdot\\frac{\\partial a^{[l]}_k}{\\partial w^{[l]}_{j,k}}\\]`}</MathJax>
            ...
            <p>
                ...
                , the <em>gradient</em> propagated backwards from layers that
                come after layer <MathJax inline>{"\\(l\\)"}</MathJax>. In order
                to simplify the calculations of the gradient, the aforementioned{" "}
                <em>upstream</em> gradient will be denoted as
            </p>
            <div className="displayLatex">
    ...
    \\end{bmatrix}^\\top\\]`}</MathJax>
            ...
            <p>
                Note that since <MathJax inline>{"\\(a^{[l]}_k\\)"}</MathJax>{" "}
                can affect the activations of all other neurons in layer{" "}
                <MathJax inline>{"\\(l+1\\)"}</MathJax>, a complete definition
                of <MathJax inline>{"\\(\\delta^{[l]}_k\\)"}</MathJax> is
            </p>
            <div className="displayLatex">
                <MathJax>{`\\[\\begin{align*}
    \\delta^{[l]}_k
    ...
    \\end{align*}\\]`}</MathJax>
            ...
            <p>
                A particular weight{" "}
                <MathJax inline>{"\\(w^{[l]}_{j,k}\\)"}</MathJax>, the gradient
                of the loss w.r.t such weight was previously defined as,
            </p>
            <div className="displayLatex">
                <MathJax>{`\\[\\begin{align*}
    \\frac{\\partial L(\\hat{y}^{(i)},y^{(i)})}{\\partial w^{[l]}_{j,k}}
    ...
    \\end{align*}\\]`}</MathJax>
            ...
            <p>
                This holds for any{" "}
                <MathJax inline>{"\\(k\\in[1,\\ldots,n_{l}]\\)"}</MathJax>, thus
                the gradient of <MathJax inline>{"\\(z^{[l]}\\)"}</MathJax>{" "}
                w.r.t <MathJax inline>{"\\(w^{[l]}\\)"}</MathJax> can be
                determined by carrying out the rest of the calculation of the
                partial derivatives,
            </p>
            <div className="displayLatex">
                <MathJax>{`\\[\\nabla_{w^{[l]}}z^{[l]}
    ...
    \\end{bmatrix}\\]`}</MathJax>
            ...
            <p>
                ...
                w.r.t <MathJax inline>{"\\(z^{[l]}\\)"}</MathJax> is essentially
                the derivative of the respective activation function{" "}
    ...
    =\\delta^{[l]}_k\\cdot g'(z^{[l]}_k)\\]`}</MathJax>
            ...
            <p>
                It is also important to find the gradient of the loss w.r.t the{" "}
                <em>activations</em> of the previous layer, i.e,{" "}
                <MathJax inline>{"\\(\\delta^{[l-1]}\\)"}</MathJax> as this is
                necessary for the backpropagation.
            </p>
            <div className="displayLatex">
                <MathJax>{`\\[\\begin{align*}
    \\delta^{[l-1]}_j
    ...
    \\end{align*}\\]`}</MathJax>
            ...
            <p>
                ...
                activation <MathJax inline>{"\\(a^{[l-1]}_j\\)"}</MathJax> is,
            </p>
            <div className="displayLatex">
            ...
            <p>
                And <MathJax inline>{"\\(\\delta^{[l-1]}_j\\)"}</MathJax> for{" "}
