        ...
        <div>
            <StaticLatexSection>
                <p>
                    ...
                    <MathJax inline>{"\\(l\\in[0,\\ldots,L]\\)"}</MathJax>{" "}
                    denote the index of a particular layer where{" "}
                    <MathJax inline>{"\\(l=0\\)"}</MathJax> denotes the{" "}
                    <em>input</em> layer and{" "}
                    <MathJax inline>{"\\(l=L\\)"}</MathJax> denotes the output
                    layer. The <MathJax inline>{"\\(l\\)"}</MathJax>-lth layer
                    is denoted to have <MathJax inline>{"\\(n_{l}\\)"}</MathJax>{" "}
                    neurons. The <em>hidden</em> layers represent layers{" "}
                ...
                <p>
                    ...
                    <MathJax inline>{"\\(j\\in[1,\\ldots,n_l]\\)"}</MathJax>,
                    the previous layer, to the{" "}
                    <MathJax inline>{"\\(k\\)"}</MathJax>-th neuron for{" "}
                ...
                <p>
                    ...
                    <MathJax inline>{"\\(l\\)"}</MathJax> is computed as the
                    output of the activation function{" "}
                    <MathJax inline>{"\\(g(z^{[l]})\\)"}</MathJax> whose input{" "}
                    <MathJax inline>{"\\(z^{[l]}\\)"}</MathJax> is a linear
                    combination of the activations of the previous layer with
                    the weights <MathJax inline>{"\\(w^{[l]}\\)"}</MathJax>,
                    i.e,
                </p>
