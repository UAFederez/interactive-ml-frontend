...
export const VectorizedImplementationSection = () => {
        ...
        <div>
            <StaticLatexSection>
                <p>
                    ...
                    implementation as opposed to solely relying on loops. While
                    it is not possible to vectorize across multiple layers given
                    the presence of the nonlinear activation function, it is
                    possible to compute all of the activations of neurons on the{" "}
                ...
                <p>
                    ...
                    <MathJax inline>{"\\(m\\)"}</MathJax> training examples,
                    each with <MathJax inline>{"\\(n\\)"}</MathJax> input
                    features. The weight matrix for a particular layer{" "}
                    <MathJax inline>
                        {"\\(w^{[l]}\\in\\mathbb{R}^{n_l\\times n_{l+1}}\\)"}
                    </MathJax>{" "}
                    is defined similarly to before. The dummy feature would not
                    be used for now as it requires an additional row of{" "}
                    <MathJax inline>{"\\(1\\)"}</MathJax>'s to each layer for
                    every layer computation.
                </p>
    ...
    b^{[l]}=\\begin{bmatrix}b^{[l]}_1 \\\\\\vdots \\\\b^{[l]}_{n_{l+1}}\\end{bmatrix}\\]`}</MathJax>
                ...
                <p>
                    The linear combinations of all the inputs in a particular
                    layer <MathJax inline>{"\\(l\\)"}</MathJax> with the
                    weights, denoted by{" "}
                    <MathJax inline>{"\\(Z^{[l]}\\)"}</MathJax>, and the
    ...
    \\end{align*}\\]`}</MathJax>
                ...
                <p>
                    ...
                    <MathJax inline>{"\\(A^{[L]}\\)"}</MathJax> can then be used
                    to calculate the loss given the{" "}
                    <MathJax inline>{"\\(Y\\)"}</MathJax> matrix,{" "}
                    <MathJax inline>{"\\(L(A^{[L]}, Y)\\)"}</MathJax>. After
                    which <MathJax inline>{"\\(\\delta^{[L]}\\)"}</MathJax> can
                    then be computed. Both these computations will vary
                ...
                <p>
                    ...
                    <MathJax inline>{"\\(Y\\)"}</MathJax> are both matrices in{" "}
                    <MathJax inline>
                        {"\\(\\mathbb{R}^{n_L\\times m}\\)"}
                    </MathJax>
                ...
                <p>
                    ...
                    <MathJax inline>{"\\(\\delta^{[l]}\\)"}</MathJax> being
                    defined as follows,
                </p>
                <div className="displayLatex">
                    <MathJax>{`\\[    g'(Z^{[l]})
    ...
    \\end{bmatrix}\\]`}</MathJax>
                ...
                <p>
                    Taking the element-wise product leads to the resulting
                    matrix in still{" "}
                    <MathJax inline>
                        {"\\(\\mathbb{R}^{n_l\\times m}\\)"}
                    </MathJax>{" "}
    ...
    \\end{bmatrix}\\]`}</MathJax>
                ...
                <p>
                    The gradient of the <em>cost</em> (since the matrices
                    already include all training samples) w.r.t the weights can
    ...
    \\end{bmatrix}\\]`}</MathJax>
                ...
                <p>
                    The gradients for the previous layer can then be calculated
                    as <MathJax inline>{"\\(\\delta^{[l-1]}\\)"}</MathJax>,
                </p>
                <div className="displayLatex">
                ...
                <p>
                    ...
                    <MathJax inline>{"\\(\\delta^{[l-1]}_{j,i}\\)"}</MathJax>{" "}
                    for <MathJax inline>{"\\(j\\in[1,\\ldots,n_l]\\)"}</MathJax>{" "}
                    and <MathJax inline>{"\\(i\\in[1,\\ldots,m]\\)"}</MathJax>{" "}
                    is defined as
                </p>
                <div className="displayLatex">
