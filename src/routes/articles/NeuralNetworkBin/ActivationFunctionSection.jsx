...
export const ActivationFunctionSection = () => {
    return (
        <div>
            <StaticLatexSection>
                ...
                <p>
                    But why must the activation function be nonlinear in the
                    first place? Suppose that the activation function{" "}
                    <em>was</em> linear, e.g., the identity function, simply the
                    output of <MathJax inline>{"\\(z^{[l]}\\)"}</MathJax>. The
                ...
                <p>
                    Note that <MathJax inline>{"\\(a^{[l-1]}\\)"}</MathJax> can
                    then be expanded as,
                </p>
                <div className="displayLatex">
                    <MathJax>{`\\[\\begin{align*}
    ...
    \\end{align*}\\]`}</MathJax>
                ...
                <p>
                    The entire model reduces down to a linear function of the
                    input activation <MathJax inline>{"\\(a^{[0]}\\)"}</MathJax>
                    ,
                </p>
                <div className="displayLatex">
                ...
                <p>
                    Where <MathJax inline>{"\\(W\\)"}</MathJax> is the product
                    of all the matrices,
                </p>
                <div className="displayLatex">
                ...
                <p>
                    ...
                    underlying assumption that the model makes is that the data
                    can be represented as a linear function of the inputs.
                </p>
                <p>
                    It is also useful later on to determine the derivatives of
                    the activation functions such as{" "}
                ...
                <p>
                    ...
                    <MathJax inline>{"\\(\\text{ReLU}(z)\\)"}</MathJax>, it
                    helps to consider its definition as a piecewise function
                </p>
                <div className="displayLatex">
    ...
    \\end{cases}\\]`}</MathJax>
                ...
                <p>
                    ...
                    <MathJax inline>{"\\(\\text{ReLU}(z)\\)"}</MathJax>, noting
                    that since the derivatives do not approach the same value
                    from both sides as{" "}
                    <MathJax inline>{"\\(z\\to 0\\)"}</MathJax>, then the
                    derivative of{" "}
                    <MathJax inline>{"\\(\\text{ReLU}(z)\\)"}</MathJax> at{" "}
                    <MathJax inline>{"\\(z=0\\)"}</MathJax> is{" "}
                    <MathJax inline>{"\\(\\text{undefined}\\)"}</MathJax>. In
                    practice, this is very rare and many software
                    implementations typically define it arbitrarily such as{" "}
